...
const productData = [
    ...
    },
    {
        ...
        image: "/Website Beta/IMAGES/images composants/Processeurs/INTEL/Intel Core i5-14400F (jusqu_à 4.7 GHz).jpg",
    ...
    },
    {
        ...
        image: "/Website Beta/IMAGES/images composants/Processeurs/INTEL/Intel Core i5-14500 (jusqu_à 5.0 GHz).jpg",
...
validateButton.addEventListener("click", () => {
    ...
    checkboxes.forEach(checkbox => {
        ...
        selectedCPU.push({ name: productName, price: productPrice });
    });

    if (selectedCPU.length > 0) {
        
        localStorage.setItem("selectedCPU", JSON.stringify(selectedCPU));

        window.location.href = "/Website Beta/Page principale/Configurateur PC.html";
    } else {
        alert("Veuillez sélectionner un processeur avant de valider.");
    }
});