...
dossier_images = "/Website Beta/IMAGES/images options/Ventilateur de boîtier/Thermalright/"
...
for fichier in fichiers_images:
    ...
    structure = {
        ...
        "image": f"/Website Beta/IMAGES/images options/Ventilateur de boîtier/Thermalright/{fichier}",
        "description": "Ecran",
        "price": 0,  
        "rating": 0,  
        "brand": f"{prefixe}",
