...
dossier_images = "/Website Beta/IMAGES/images périphériques/Tapis de souris/SteelSeries/"
...
for fichier in fichiers_images:
    ...
    structure = {
        ...
        "image": f"/Website Beta/IMAGES/images périphériques/Tapis de souris/SteelSeries/{fichier}",
        "description": "",
        "price": 0,  
        "rating": 0,  
        "brand": f"{prefixe}",
